...
const comments = require("../../comments/app");
...
module.exports = (log, pgdb) => {
    ...
    const topicSubjectMiddleware = (req, res, next) => {
        req.commentSubject = req.params.topicId;
        next();
    };

    app.use("/:topicId/comments", authenticate, topicSubjectMiddleware, comments(log, pgdb, "topics"));
